...
const SearchBox = ({
  ...
  const startPadding = startIcon
    ? styles.startIconView.marginStart +
      styles.startIcon.width +
      styles.startIconView.marginEnd
    : null;
    ...
    <View style={[{ flexDirection: "row" }, style]}>
      <View style={{ flexDirection: "row", flex: 1 }}>
        <TextInput
          style={[
            getStyle(focus),
            startIcon ? { paddingStart: startPadding } : null,
          ]}
        ...
        />
        {startIcon && (
          <View style={[styles.startIconView, startIconViewStyle]}>
            <Image
              source={startIcon}
        ...
        {text.length !== 0 && focus ? (
          <TouchableOpacity
            ...
            style={[styles.clearIconView, clearIconViewStyle]}
            activeOpacity={1}
          >
            <Image
              source={clrIcon}
